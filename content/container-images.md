...
{{ callout("<strong>~2,000-line Containerfile</strong> with 20+ intermediate stages. Builder image compiles everything from source for full supply chain control.") }}
