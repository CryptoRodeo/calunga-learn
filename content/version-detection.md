...
{{ diagram("sequenceDiagram
    ...
    GH->>Script: Trigger
    Script->>PyPI: Async query 1,547 packages
...
{{ callout("<strong>Async queries</strong> - all 1,547 packages checked concurrently.<br><strong>Smart filtering</strong> - pre-releases, yanked releases, and <code>ignored_versions</code> all excluded.<br><strong>Labels:</strong> PRs tagged \"automated build\" for tracking.") }}
